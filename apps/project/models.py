...
class DeployInfo(models.Model):
    ...
    prjname = models.CharField(max_length=100, unique=True, verbose_name='参数名称')
    prjalias = models.CharField(max_length=32, verbose_name='初始值')
    deploypath = models.CharField(max_length=200, verbose_name='当前值')
    depldescr = models.TextField(null=True, blank=True, verbose_name='参数描述')
    def __str__(self):
        return self.prjname
